...
import 'package:cel/src/gen/google/api/expr/v1alpha1/checked.pb.dart'
    as checked_pb;
  ...
  group('has() macro tests', () {
    ...
    setUp(() {
      ...
      registry.registerMessageType('cel.expr.conformance.proto3.TestAllTypes',
          TestAllTypes().info_, () => TestAllTypes());
    ...
    test('has() with || operator', () {
      final ast =
          env.compile('has(msg.single_int32) || has(msg.single_string)');
      final program = env.makeProgram(ast);
