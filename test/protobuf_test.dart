...
void main() {
  group('Protobuf Integration', () {
    ...
    test('can evaluate CEL expressions with messages', () {
      ...
      final ast = env.compile('msg.single_int32 == 42 && msg.single_string == "hello"');
    ...
    test('can handle map fields', () {
      ...
      expect((map.value[StringValue('key1')] as StringValue).value, equals('value1'));
      expect((map.value[StringValue('key2')] as StringValue).value, equals('value2'));
    });
    ...
    test('can use "this" variable binding', () {
      ...
      final ast = env.compile('this.single_int32 == 42 && this.single_string == "hello"');
      final program = env.makeProgram(ast);
    ...
    test('can use custom variable bindings', () {
      ...
      final ast = env.compile('this.single_int32 > rules.min && this.single_int32 < rules.max');
      final program = env.makeProgram(ast);
    ...
    test('can handle enum fields', () {
      ...
      expect((enumField as IntValue).value, equals(TestAllTypes_NestedEnum.BAR.value));
    });
