...
class SimpleTest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(14)
  set locale($core.String value) => $_setString(13, value);
  @$pb.TagNumber(14)
  $core.bool hasLocale() => $_has(13);
  @$pb.TagNumber(14)
  void clearLocale() => $_clearField(14);

  /// Disables the evaluate phase.
  @$pb.TagNumber(15)
  $core.bool get checkOnly => $_getBF(14);
  @$pb.TagNumber(15)
  set checkOnly($core.bool value) => $_setBool(14, value);
  @$pb.TagNumber(15)
  $core.bool hasCheckOnly() => $_has(14);
  @$pb.TagNumber(15)
  void clearCheckOnly() => $_clearField(15);

  /// A result and deduced expression type.
  @$pb.TagNumber(16)
  TypedResult get typedResult => $_getN(15);
  @$pb.TagNumber(16)
  set typedResult(TypedResult value) => $_setField(16, value);
  @$pb.TagNumber(16)
  $core.bool hasTypedResult() => $_has(15);
  @$pb.TagNumber(16)
  void clearTypedResult() => $_clearField(16);
  @$pb.TagNumber(16)
  TypedResult ensureTypedResult() => $_ensure(15);
}
